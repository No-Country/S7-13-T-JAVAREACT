        ...
        <main className={styles.container}>
            ...
            <div className={styles.containerNavigation}>
                <div className={styles.containerButton}>
                    {
                        (page!==3)
                        ?<>
                            <button onClick={()=>{setPage(page+1)}} className={styles.buttonOmitir}>Omitir</button>
                            <button onClick={()=>{setPage(page+1)}} className={styles.buttonSiguiente}>Siguiente</button>
                        </>
                        :<>
                            <Link className={styles.buttonTerminar} href={"/"}>
                                <button onClick={()=>{setPage(page+1)}} >Terminar</button>
                            </Link>
                        </>
                    }
                </div>
                <div className={styles.containerBarra}>
                    ...
                    <div style={{width: `${porcentaje}%`}} className={styles.barra}></div>
                </div>
            </div>
        </main>
    )
