            ...
            <div className={styles.containerInfo}>
                ...
                <div className={styles.containerText}>
                    <p className={styles.h1}>
                        Con nuestro plan premium podrás acceder a todas las funciones de PortaCode
                    </p>
                    <p className={styles.p}>
                        <ul className={styles.ul}>
                            <li className={styles.li}>Todos los componentes para tus diseños</li>
                            <li className={styles.li}>Dominios personalizados</li>
                            <li className={styles.li}>Herramientas de análisis en tu sitio</li>
                            <li className={styles.li}>Asesoramiento especial de nuestro equipo</li>
                        </ul>
                    </p>
                </div>
